...
export default function Home() {
  return (
    <main className="w-full h-screen bg-[#F4D04E] flex justify-center items-center">
      <section
        className="w-[327px] h-[501px] bg-white rounded-[20px] p-6 border-black border-solid border-[1px] shadow-[8px_8px_0px_0px_rgba(0,0,0,0.75)]">
        <div className="w-[279px] h-[200px] rounded-[10px] overflow-hidden relative mb-6">
          <svg
        ...
        <div className="w-[73px] h-[26px] rounded bg-[#F4D04E] flex justify-center items-center mb-3">
          <h6 className="text-black font-extrabold text-xs text-center align-middle">Learning</h6>
        </div>
        <h6 className="text-black font-medium text-xs align-middle  mb-3">Published 2 May 2024</h6>
        <h2 className="text-black font-extrabold text-xl  align-middle  mb-3">HTML & CSS foundations</h2>
        <h2 className="font-medium text-sm text-[#828282] align-middle  mb-6">These languages are the backbone of
          every
